...
public class RemoveDuplicatesTokenFilterFactory extends AbstractTokenFilterFactory {
    ...
    @Inject
    public RemoveDuplicatesTokenFilterFactory(Index index, @IndexSettings Settings indexSettings, Environment environment, @Assisted String name, @Assisted Settings settings) {
