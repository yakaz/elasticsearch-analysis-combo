...
public class RemoveDuplicateTokenFilterTests extends Assert {
    ...
    private String words = "Please do not state the obvious.";
    ...
    public void testBasicUsage() throws Exception {
        ...
        Settings settings = ImmutableSettings.settingsBuilder()
                ...
                .put("index.analysis.filter.removefilter.type", "removedups")
        ...
        assertEquals("please pleas pleas do do do not state stat state the obviou obvious obvious ", dump(ts1).toString());
        TokenFilterFactory filterFactory = analysisService.tokenFilter("removefilter");
        TokenStream ts2 = filterFactory.create(analyzer.reusableTokenStream("field1", new StringReader(words)));
        assertEquals("please pleas do not state stat the obviou obvious ", dump(ts2).toString());
    }
